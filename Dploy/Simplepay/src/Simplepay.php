...
use Dploy\Simplepay\ResultCheck;
use Dploy\Simplepay\SimplepayResponse;
use Dploy\Simplepay\SimplepayRequest;
...
*/
	...
	*/
	...
	{	
		...
		if( empty($params->id) ){
			throw new SimplepayException("Registration Id not found");
		}
		else
			return true;
	}
